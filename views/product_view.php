                    ...
                    <form method="" class="form-inline" action="">
                      <div class="form-group">
                        <!-- <div class="input-group col-sm-7">		
                          ...
                          <input type="hidden" value="<?= $product['prodid'] ?>" id="product_id" name="product_id">
                        </div>
                        <button type="submit" name="add_cart" class="btn btn-primary btn-lg btn-flat"><i class="fa fa-shopping-cart"></i> Add to Cart</button> -->
                        <a href="../controllers/cart_add.php?prodid=<?= base64_encode($product['prodid']) ?>" class="btn btn-primary btn-lg btn-flat add_cart"><i class="fa fa-shopping-cart"></i> Ajouter au panier</a>
                      </div>
                    </form>
                  </div>
                  <div class="col-sm-6">
