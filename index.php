<!-- tête -->
<?php include 'views/includes/tete_page.php' ?>
...
<body class="hold-transition skin-blue layout-top-nav">
    <div class="wrapper">
                ...
                <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <li><a href='category.php?category=laptops'>Chaussures</a></li>
                                <li><a href='category.php?category=desktop-pc'>Chémises PC</a></li>
            ...
            <div class="container">
                ...
                <section class="content">
                    <div class="row">
                        ...
                        <!-- cote de page   -->
                        <?php include 'views/includes/cote_page.php' ?>  
        ...
        <!-- pied -->
        <?php include 'views/includes/pied_page.php' ?>
    </div>
